...
namespace SalesWebMvc.Data
{
    public class SeedingService // Servico para popular a base de dados
    {
        ...
        // Operacao (Metodo) para popular a base de dados
        public void Seed()
        {
            /* "Any" testa se ha registros nas tabelas do Banco de Dados. Caso haja, termina a execucao do Metodo,
             * pois o Banco de Dados ja esta populado */
            ...
            // Department d5 = new Department { Id = 5, Name = "Tools" } // Sintaxe alternativa
            ...
            _context.SalesRedcord.AddRange(
                r1, r2, r3, r4, r5, r6, r7, r8, r9, r10,
                r11, r12, r13, r14, r15, r16, r17, r18, r19, r20,
                r21, r22, r23, r24, r25, r26, r27, r28, r29, r30
            );

            // Efetivar a povoacao do banco de dados
            _context.SaveChanges(); // Salva e confirma as alteracoes ao banco de dados
        }
    }
}
